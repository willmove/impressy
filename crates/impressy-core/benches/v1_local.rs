...
use impressy_core::beautify::{self, Background, BeautifyParams, Border, GradientDirection, Shadow};
use impressy_core::transform::{self, ResizeFilter};
...
fn main() {
    println!("Impressy v1 core performance probe (release profile, single sample)");
    println!("-----------------------------------------------------------------");
