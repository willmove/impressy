...
use impressy_core::exif;
use impressy_core::format::{self, EncodeSettings, Quality};
use impressy_core::qr;
use impressy_core::qr::QrOptions;

proptest! {
    #![proptest_config(ProptestConfig::with_cases(32))]

    // Feature: impressy, Property 2: QR round-trip preserves content
    #[test]
...
// Feature: impressy, Property 22: QR re-encoding is idempotent
#[test]
...
// Feature: impressy, Property 25: Corrupted QR code returns error without crash
proptest! {
    #[test]
...
#[test]
// Feature: impressy, Property 4: EXIF cleaning removes metadata and preserves pixels
...
#[test]
// Feature: impressy, Property 20: EXIF cleaning is idempotent
