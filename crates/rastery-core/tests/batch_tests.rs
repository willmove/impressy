...
use rastery_core::format::{self, EncodeSettings, OutputFormat, Quality};
use rastery_core::transform::ResizeFilter;
use rastery_core::watermark::Position;
...
proptest! {
    // Feature: rastery, Property 8 + 9 + 10: format conversion preserves count, order, dims
    #[test]
    ...
    // Feature: rastery, Property 12: resize preserves count
    #[test]
    ...
    // Feature: rastery, Property 13: watermark preserves count
    #[test]
...
// Feature: rastery, Property 8 (failure path): failures counted, total preserved
#[test]
