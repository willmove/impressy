...
use rastery_core::watermark::{self, Position};
use std::io::Cursor;

proptest! {
    #![proptest_config(ProptestConfig::with_cases(32))]

    // Feature: rastery, Property 17: GIF frame count matches input
    #[test]
...
// Feature: rastery, Property 18: Beautify transparent bg produces true transparency
#[test]
...
// Feature: rastery, Property 28: Beautification padding increases dimensions predictably
#[test]
