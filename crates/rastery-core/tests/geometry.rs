...
proptest! {
    // Feature: rastery, Property 15: 360-degree rotation is identity
    #[test]
...
// Feature: rastery, Property 14: Cropped image matches selected aspect ratio (exactly)
#[test]
...
// Feature: rastery, Property 5: Image slicing produces exactly M×N tiles
#[test]
...
// Feature: rastery, Property 6: Collage contains all input images (vertical: N cells stacked)
#[test]
...
// Feature: rastery, Property 7: Grid collage has specified columns
#[test]
