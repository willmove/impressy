...
impl From<rastery_ai::AiError> for AiErrorKind {
    fn from(error: rastery_ai::AiError) -> Self {
        match error {
            rastery_ai::AiError::ApiKeyRequired | rastery_ai::AiError::CredentialMissing => {
                Self::KeyRequired
            }
            rastery_ai::AiError::InvalidCredentials => Self::InvalidKey,
            rastery_ai::AiError::InsufficientBalance => Self::InsufficientBalance,
            rastery_ai::AiError::RateLimited => Self::RateLimited,
            rastery_ai::AiError::Network => Self::Network,
            rastery_ai::AiError::ContentBlocked => Self::ContentBlocked,
            rastery_ai::AiError::ImageTooLarge { .. } => Self::ImageTooLarge,
            rastery_ai::AiError::UnsupportedCapability(_)
            | rastery_ai::AiError::TooManyReferenceImages { .. } => Self::Unsupported,
            rastery_ai::AiError::InvalidRequest(_) => Self::InvalidRequest,
            rastery_ai::AiError::CredentialStore => Self::Credential,
            rastery_ai::AiError::ProviderUnavailable | rastery_ai::AiError::InvalidResponse => {
                Self::Provider
            }
        }
    }
