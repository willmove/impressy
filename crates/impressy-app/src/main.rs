//! impressy-app：GPUI 桌面应用入口。
//!
//! 四大板块导航（Requirement 34）+ 多语言（Requirement 35）。本地功能由
//! `impressy-core` 提供，AI 图片功能由 `impressy-ai` 与 `impressy-presets` 提供；三个视频
...
mod tests {
    ...
    fn desktop_identity_matches_packaging_assets() {
        assert_eq!(APP_ID, "app.impressy.Impressy");
    }
}
